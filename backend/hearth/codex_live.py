...
from hearth.codex_events import MAX_STREAM, CodexEvents
from hearth.codex_pricing import MODEL, estimate_api_equivalent
from hearth.codex_usage import UsageBinding, publish, read
...
class CodexLiveRuntime:
    ...
    def start(self, run_id, instruction):
        ...
        with container_lock(self.root / ".launch.lock"):
            ...
            subprocess.Popen(
                [sys.executable, "-I", "-m", "hearth.codex_live", str(folder)],
                cwd=folder,
                env={"PATH": os.defpath},
