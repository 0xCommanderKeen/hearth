...
its own first task. The number is a proposal and not a floor: the operator edits the
field before creating, and nothing refuses a smaller allowance. `daily_limit` remains
